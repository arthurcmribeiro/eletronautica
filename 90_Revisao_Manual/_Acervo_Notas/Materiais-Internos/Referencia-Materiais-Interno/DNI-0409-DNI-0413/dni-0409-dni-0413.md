---
title: "DNI 0409 DNI 0413 - Referencia tecnica - DNI-0409-DNI-0413"
...
source_pdf: "Materiais-Internos/Referencia-Materiais-Interno/DNI-0409-DNI-0413/dni-0409-dni-0413.pdf"
...
detected_document_codes: "DNI-0409-DNI-0413, 3933-2120"
curation_topics: "alimentacao eletrica, cabos e ligacoes, instalacao fisica"
aliases:
...
# DNI 0409 DNI 0413 - Referencia tecnica - DNI-0409-DNI-0413
...
- PDF: [dni-0409-dni-0413.pdf](</C:/Users/User/Desktop/ELETRO NAUTICA OBSIDIAN/ELETRO NAUTICA/90_Revisao_Manual/_Acervo_Local/Materiais-Internos/Referencia-Materiais-Interno/DNI-0409-DNI-0413/dni-0409-dni-0413.pdf>)
- caminho relativo: `Materiais-Internos/Referencia-Materiais-Interno/DNI-0409-DNI-0413/dni-0409-dni-0413.pdf`
- nota companheira: `90_Revisao_Manual/_Acervo_Notas/Materiais-Internos/Referencia-Materiais-Interno/DNI-0409-DNI-0413/dni-0409-dni-0413.md`
...
- codigos tecnicos/documentais detectados: `DNI-0409-DNI-0413, 3933-2120`
- datas/revisoes detectadas: `n/a`
- termos uteis detectados: `12v, air`
- topicos de curadoria: `alimentacao eletrica, cabos e ligacoes, instalacao fisica`
...
- `lâmpada de carga da bateria`
- `CUIDADOS NA INSTALAÇÃO:`
- `- Veículos com módulo de conforto, podem não aceitar a instalação deste`
- `da bateria`
- `Mas a ligação via chave *ON/OFF ainda pode ser`

### Especificacoes e linhas de valor tecnico

- `- Potência máxima de 150W. Para potências maiores, utilize Relés auxiliares DNI.`
- `Potência Máx. 150W`
- `pressão de óleo (lado da cebolinha) ou a`
- `lâmpada de carga da bateria`
...
- `Potência Máx. 480W`
- `Mas a ligação via chave *ON/OFF ainda pode ser`
- `o terminal 30 do relé 0102/0212 no negativo da bateria.`
