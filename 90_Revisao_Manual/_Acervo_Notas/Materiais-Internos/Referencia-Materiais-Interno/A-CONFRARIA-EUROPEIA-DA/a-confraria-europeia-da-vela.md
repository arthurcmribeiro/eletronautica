---
title: "A CONFRARIA EUROPEIA DA - Referencia tecnica - Novicio _trad. borrador portugués"
...
source_pdf: "Materiais-Internos/Referencia-Materiais-Interno/A-CONFRARIA-EUROPEIA-DA/a-confraria-europeia-da-vela.pdf"
source_sha256: "7a2b74af48fff6448c70b2cf3a7c26b7f2ccf18b78cbb87a9e681f87e9c3e0b6"
acervo_system: "Materiais-Internos"
acervo_brand: "Referencia-Materiais-Interno"
acervo_family: "A-CONFRARIA-EUROPEIA-DA"
...
curation_topics: "manutencao, resfriamento/agua"
aliases:
  - "a-confraria-europeia-da-vela.pdf"
related_notes:
...
# A CONFRARIA EUROPEIA DA - Referencia tecnica - Novicio _trad. borrador portugués
...
- PDF: [a-confraria-europeia-da-vela.pdf](</C:/Users/User/Desktop/ELETRO NAUTICA OBSIDIAN/ELETRO NAUTICA/90_Revisao_Manual/_Acervo_Local/Materiais-Internos/Referencia-Materiais-Interno/A-CONFRARIA-EUROPEIA-DA/a-confraria-europeia-da-vela.pdf>)
- caminho relativo: `Materiais-Internos/Referencia-Materiais-Interno/A-CONFRARIA-EUROPEIA-DA/a-confraria-europeia-da-vela.pdf`
- nota companheira: `90_Revisao_Manual/_Acervo_Notas/Materiais-Internos/Referencia-Materiais-Interno/A-CONFRARIA-EUROPEIA-DA/a-confraria-europeia-da-vela.md`
- tamanho do arquivo: `68.3 KB`
- paginas detectadas: `7`
- versao PDF: `1.4`
- PDF criptografado: `nao`
- titulo em metadados: `Novicio _trad. borrador portugués`
...
- familia: `A-CONFRARIA-EUROPEIA-DA`
- marcas detectadas: `n/a`
- codigos/modelos detectados: `CONFRARIA, EUROPEIA`
- codigos tecnicos/documentais detectados: `n/a`
- datas/revisoes detectadas: `n/a`
- termos uteis detectados: `spec`
- topicos de curadoria: `manutencao, resfriamento/agua`

## Extracao tecnica automatica

### Secoes e assuntos provaveis

- `para a manutenção da CONFRARIA. As quotas são fixadas`
...
- marca/familia: `Referencia-Materiais-Interno / A-CONFRARIA-EUROPEIA-DA`
...
- `para a manutenção da CONFRARIA. As quotas são fixadas`
- `A Confraria EUROPEIA DA VELA`
- `Sua origem, finalidade e funcionamento`
- `A Confraria Europeia da Vela (CEV) foi constituída na cidade de`
- `Sanxenxo, em 15 de Fevereiro de 2001. Os seus fundadores são`
- `pessoas ligadas ao mundo da Vela e navegação em geral, que`
- `queriam criar uma instituição, completamente independente de`
- `outras instituições já existentes, tendo como objectivo`
- `compartilhar e proteger a cultura do mar e da Vela, sendo este o`
- `factor de união entre todos eles. A ideia partiu de D. Francisco`
- `Quiroga e os fundadores foram pessoas, principalmente galegos`
- `e portugueses, bem como de outras comunidades de Espanha,`
