---
title: "722 NE - Referencia tecnica - INST-722-NE-300A-V1.doc"
...
source_pdf: "Energia-DC/Referencia-Energia-DC/722-NE/722-ne.pdf"
...
curation_topics: "alimentacao eletrica, protecao e seccionamento, cabos e ligacoes, operacao"
aliases:
  - "722-ne.pdf"
related_notes:
...
# 722 NE - Referencia tecnica - INST-722-NE-300A-V1.doc
...
- PDF: [722-ne.pdf](</C:/Users/User/Desktop/ELETRO NAUTICA OBSIDIAN/ELETRO NAUTICA/90_Revisao_Manual/_Acervo_Local/Energia-DC/Referencia-Energia-DC/722-NE/722-ne.pdf>)
- caminho relativo: `Energia-DC/Referencia-Energia-DC/722-NE/722-ne.pdf`
- nota companheira: `90_Revisao_Manual/_Acervo_Notas/Energia-DC/Referencia-Energia-DC/722-NE/722-ne.md`
- tamanho do arquivo: `336.4 KB`
- paginas detectadas: `5`
- versao PDF: `1.6`
- PDF criptografado: `nao`
- titulo em metadados: `INST-722-NE-300A-V1.doc`
...
- topicos de curadoria: `alimentacao eletrica, protecao e seccionamento, cabos e ligacoes, operacao`
...
- `722-NE-300A can switch either 12 or 24 volt`
- `3 Amp momentary draw to operate.`
- `300 Amps continuous rating.`
- `1500 Amps for 10 seconds.`
- `INST-722-NE-300A`
- `THE 722-NE-300A`
...
- `The battery switch is remotely operated via a key switch (part number 722-KS2) which can be`
- `In “automatic” mode the Battery Switch is switched on and off from the remote switch.`
- `OFF: The battery switch is open and not passing current.`
- `ON: The battery switch is closed and able to pass current.`
...
- marca/familia: `Referencia-Energia-DC / 722-NE`
