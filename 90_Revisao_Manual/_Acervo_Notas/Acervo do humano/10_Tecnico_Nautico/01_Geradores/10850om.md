...
source_file: "01_Geradores/10850om.pdf"
...
- arquivo: [10850om.pdf](</C:/Users/User/Desktop/ELETRO NAUTICA OBSIDIAN/ELETRO NAUTICA/90_Revisao_Manual/_Acervo_Local/Acervo do humano/10_Tecnico_Nautico/01_Geradores/10850om.pdf>)
- nome original: `10850OM.pdf`
- caminho original: `01_Geradores/10850OM.pdf`
- caminho atual: `01_Geradores/10850om.pdf`
- nota companheira: `90_Revisao_Manual/_Acervo_Notas/Acervo do humano/10_Tecnico_Nautico/01_Geradores/10850om.md`
- extensao: `.pdf`
- tamanho do arquivo: `272.6 KB`
- texto extraivel detectado: `sim`
- metodo de extracao: `pdftotext`
- caracteres extraidos: `3429`
...
- termos uteis detectados: `battery, control, controls, installation, manual, service, spec, troubleshooting`
...
- `• Additional features on Freedom 458 and Marine Series include`
