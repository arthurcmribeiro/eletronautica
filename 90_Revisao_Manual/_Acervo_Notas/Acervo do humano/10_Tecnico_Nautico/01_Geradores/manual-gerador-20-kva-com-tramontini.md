---
title: "manual gerador 20 kva com tramontini"
...
source_file: "01_Geradores/manual-gerador-20-kva-com-tramontini.pdf"
source_sha256: "1f2426c552d934e981873a03061cbadf9de97c0d8a4ec1314e2890c5f77372b6"
acervo_bucket: "Geradores"
acervo_system: "Geradores"
acervo_brand: "A revisar"
acervo_family: "GERADOR"
extraction_method: "pdftotext"
text_extractable: "sim"
extracted_text_chars: 3819
indexed_text_path: ""
...
aliases:
  - "Manual-Gerador-20-kva-com-Tramontini.pdf"
  - "manual-gerador-20-kva-com-tramontini.pdf"
related_notes:
...
# manual gerador 20 kva com tramontini
...
- arquivo: [manual-gerador-20-kva-com-tramontini.pdf](</C:/Users/User/Desktop/ELETRO NAUTICA OBSIDIAN/ELETRO NAUTICA/90_Revisao_Manual/_Acervo_Local/Acervo do humano/10_Tecnico_Nautico/01_Geradores/manual-gerador-20-kva-com-tramontini.pdf>)
- nome original: `Manual-Gerador-20-kva-com-Tramontini.pdf`
- caminho original: `01_Geradores/Manual-Gerador-20-kva-com-Tramontini.pdf`
- caminho atual: `01_Geradores/manual-gerador-20-kva-com-tramontini.pdf`
- nota companheira: `90_Revisao_Manual/_Acervo_Notas/Acervo do humano/10_Tecnico_Nautico/01_Geradores/manual-gerador-20-kva-com-tramontini.md`
- extensao: `.pdf`
- tamanho do arquivo: `821.0 KB`
- texto extraivel detectado: `sim`
- metodo de extracao: `pdftotext`
- caracteres extraidos: `3819`
...
- codigos/modelos detectados: `GERADOR, 20-KVA`
- termos uteis detectados: `control, manual`
...
- `SOTO FILHOS GERADORES`
- `MANUAL TÉCNICO E ESQUEMA`
- `ELÉTRICO DE ALTERNADOR POWER`
- `E MOTOR DIESEL TRAMONTINI`
- `WWW.SOTOFILHOS.COM.BR`
- `Recomendações Gerais`
- `-Siga corretamente o Plano de Manutenção Preventivo;`
- `-Leia atentamente as Medidas de Segurança;`
- `-Os atendimentos em garantia estão condicionados ao TERMO DE GARANTIA. Portanto, leiao com atenção;`
- `-Todo o motor novo é fornecido com óleo lubrificante no cárter. Porém, antes de acioná-lo`
