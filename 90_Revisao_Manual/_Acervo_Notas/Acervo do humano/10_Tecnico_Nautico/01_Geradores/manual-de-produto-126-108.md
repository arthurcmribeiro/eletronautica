---
title: "manual de produto 126 108"
...
source_file: "01_Geradores/manual-de-produto-126-108.pdf"
source_sha256: "157ce2010aaab087c59fc65f6e2a630c02de57e518207664e5bffe9525efbf6b"
acervo_bucket: "Geradores"
acervo_system: "Geradores"
acervo_brand: "Cummins / Onan"
acervo_family: "PRODUTO"
extraction_method: "pdftotext"
text_extractable: "sim"
extracted_text_chars: 21962
indexed_text_path: ""
...
- arquivo: [manual-de-produto-126-108.pdf](</C:/Users/User/Desktop/ELETRO NAUTICA OBSIDIAN/ELETRO NAUTICA/90_Revisao_Manual/_Acervo_Local/Acervo do humano/10_Tecnico_Nautico/01_Geradores/manual-de-produto-126-108.pdf>)
- nome original: `manual-de-produto-126-108.pdf`
- caminho original: `01_Geradores/manual-de-produto-126-108.pdf`
- caminho atual: `01_Geradores/manual-de-produto-126-108.pdf`
- nota companheira: `90_Revisao_Manual/_Acervo_Notas/Acervo do humano/10_Tecnico_Nautico/01_Geradores/manual-de-produto-126-108.md`
- extensao: `.pdf`
- tamanho do arquivo: `1.1 MB`
- texto extraivel detectado: `sim`
- metodo de extracao: `pdftotext`
- caracteres extraidos: `21962`
...
- codigos/modelos detectados: `PRODUTO, MT-512e, MT-512EL, SB59`
- termos uteis detectados: `12v, air, control, controls, manual, spec`
...
- `MT512E2HP12-05T-13888`
- `CONTROLADOR E INDICADOR DIGITAL PARA`
- `AQUECIMENTO OU REFRIGERAÇÃO COM`
- `DEGELO NATURAL POR PARADA DO COMPRESSOR`
- `Bloqueio de Desliga funções Programação Grau de`
- `em série proteção`
- `Imagem I: MT-512E 2HP - 115Vac`
- `1. DESCRIÇÃO`
- `Com o MT-512e 2HP é possível realizar degelos periódicos por parada do compressor (degelo`
- `natural) e forçar degelos manualmente. Possui um potente relé de 16A para acionar cargas de até 2HP,`
